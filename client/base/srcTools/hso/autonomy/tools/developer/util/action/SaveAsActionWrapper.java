...
public class SaveAsActionWrapper extends AbstractAction implements PropertyChangeListener, IPerspectiveManagerListener
{
	private final IPerspectiveManager model;

	private Action saveAction;

	public SaveAsActionWrapper(IPerspectiveManager model)
	{
		super("Save As...", ImageFile.SAVE_AS.getIcon());
	...
	public void activeViewChanged()
	{
		if (model.getActiveView() != null) {
			setSaveAsAction(model.getActiveView().getSaveAsAction());
		} else {
			setSaveAsAction(null);
		}
	}
