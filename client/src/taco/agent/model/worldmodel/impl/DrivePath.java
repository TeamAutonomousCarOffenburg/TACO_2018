...
public class DrivePath
{
	...
	public DrivePath(SegmentLink[] links, IPose3D[] poses, DriveInstruction[] instructions)
	{
		this();
		...
		int i = 0;
		for (IPose3D pose : poses) {
			add(links[i], pose, new Maneuver(instructions[i], 0, i));
			i++;
		}
	}

	public void add(SegmentLink goalLink, IPose3D pose, Maneuver maneuver)
	{
