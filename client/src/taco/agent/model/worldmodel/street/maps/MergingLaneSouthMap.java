...
public class MergingLaneSouthMap
{
	public static StreetMap create()
	{
		...
		current = appendStraights(xNorthCrossing, WEST, 3);
		...
		current = appendStraights(westCrossing, EAST, 4);
		...
		current = mergingIn3.getOutOption(WEST).appendCurveSmallRight();
