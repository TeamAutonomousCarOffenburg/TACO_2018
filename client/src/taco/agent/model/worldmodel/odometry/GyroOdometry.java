...
public class GyroOdometry extends Odometry
{
	...
	public GyroOdometry(float wheelDiameter, IPose3D startPose)
	{
		super(startPose);
	...
	public IPose3D update(long leftTicks, int leftDir, long rightTicks, int rightDir, Angle zAngle)
	{
		...
		// TODO 3D
		pose = pose.applyTo(new Pose3D(DriveGeometry.calculateArcPose(distance, deltaAngle)));
