...
public enum Scenario {
	...
	EMERGENCYCAR(() -> new EmergencyCarScenario(3)),
	FOLLOW_LANE_LEARNING(() -> new FollowLaneLearningScenario(5)),
	MERGING_NORTH(MergingNorthScenario::new),
	MERGING_EAST(MergingEastScenario::new),
	MERGING_SOUTH(MergingSouthScenario::new),
	MERGING_WEST(MergingWestScenario::new),
	AADC_2015(AADC2015Scenario::new),
	AADC_2017_QUALI(AADC2017QualiScenario::new),
	AADC_2017_FINAL(AADC2017FinalScenario::new),

	/* AADC 2018 */
	AADC_2018_QUALI(AADC2018QualiScenario::new),
	AADC_2018_FINAL(AADC2018FinalScenario::new);
