...
public class AudiCupPerception extends Perception implements IAudiCupPerception
{
	...
	@Override
	public ILidarPerceptor getLidarPerceptor()
	{
		return (ILidarPerceptor) perceptors.get(PerceptorName.LIDAR_FRONT);
	}
	...
	@Override
	public IPositionPerceptor getPositionPerceptor()
	{
		return (IPositionPerceptor) perceptors.get(PerceptorName.POSITION);
	}
