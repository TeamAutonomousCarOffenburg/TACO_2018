...
public class PerceptionMessage
{
	...
	@SerializedName(LIDAR_FRONT)
	//	public DoubleArrayPerceptor lidarFront;
	public LidarPerceptor lidarFront;
	...
	public PositionPerceptor position;
	...
	public Map<String, IPerceptor> toPerceptorMap()
	{
		...
		add.accept(LIDAR_FRONT, lidarFront);
