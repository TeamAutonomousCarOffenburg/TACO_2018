...
public class AudiCupClient
{
	public static void main(String[] args)
	{
		...
		DoubleArgument startX = new DoubleArgument("startX", 0.0, "initial x coordinate of the car");
		DoubleArgument startY = new DoubleArgument("startY", 0.0, "initial y coordinate of the car");
		...
		IPose3D startPose = null;
		if (startX.isSpecified() && startY.isSpecified() && startAngle.isSpecified()) {
			startPose = new Pose3D(startXValue, startYValue, Angle.deg(startAngleValue));
		}
