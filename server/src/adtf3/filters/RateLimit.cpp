...
ADTF_TRIGGER_FUNCTION_FILTER_PLUGIN(CID_TACO_RATE_LIMIT_SERVICE, RATE_LIMIT_FILTER_NAME, RateLimit,
		adtf::filter::pin_trigger({"ultrasonic_struct", "voltage_struct", "iner_meas_unit", "wheel_left", "wheel_right",
				"laser_scanner"}));
