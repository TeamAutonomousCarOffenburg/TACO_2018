...
JSONCarMetaModel::JSONCarMetaModel(double floorHeight, std::string steeringServoName, std::string mainMotorName,
		...
		std::vector<IDistanceSensorConfig::ConstPtr> lidarConfigs, std::vector<ISensorConfig::ConstPtr> rotationConfigs,
		std::vector<ISensorConfig::ConstPtr> voltageConfigs, std::vector<ICameraConfig::ConstPtr> cameraConfigs,
